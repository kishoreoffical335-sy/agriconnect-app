...
import { getLanguage, INDIAN_LANGUAGES, LanguageCode, t } from '@/lib/i18n';
...
const COMMON: Record<string, Partial<Record<LangShort, string>>> = {
  ...
  "FPO": {"hi":"एफपीओ","bn":"এফপিও","te":"ఎఫ్‌పీఓ","mr":"एफपीओ","ta":"எஃப்பிஓ","gu":"એફપીઓ","kn":"ಎಫ್‌ಪಿಒ","ml":"എഫ്‌പിഒ","pa":"ਐਫਪੀਓ","or":"ଏଫପିଓ","as":"এফপিঅ'","ur":"ایف پی او"},
  ...
  "My Earnings": {"hi":"मेरी कमाई","bn":"আমার আয়","te":"నా ఆదాయం","mr":"माझी कमाई","ta":"எனது வருமானம்","gu":"મારી કમાણી","kn":"ನನ್ನ ಆದಾಯ","ml":"എന്റെ വരുമാനം","pa":"ਮੇਰੀ ਕਮਾਈ","or":"ମୋ ଆୟ","as":"মোৰ উপাৰ্জন","ur":"میری آمدنی"},
